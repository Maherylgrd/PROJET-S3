<?php 
   ...
   //1 
    ...
    header('Location:../template.php?page=users/resultat&totalPoid='.$totalPoid.'&totalRestantParcelle='.$totalRestantParcelle.'&montDep='.$montDep.'&benef='.$benef.'&coupderevient='.$coupderevient);
